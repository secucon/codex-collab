...
**Symptoms**: Orchestrator cannot locate session context; evaluation is blocked immediately.

**Mitigation**:
- Display a clear prompt: *"활성 세션이 없습니다. `/codex-session start <이름>`으로 시작하세요."*
...
|---|---|---|---|
| 1 | No active session | Orchestrator pre-check | Block + guide to `/codex-session start` |
